...
from framework.common.response.constants.media_type_constants import MediaTypeConstants
from framework.common.response.core.response_headers import ResponseHeaders
from framework.common.response.core.streaming_result import StreamingResult
...
class FileResult:
    ...
    def stream_bytes(
        ...
        *,
        ...
        return StreamingResult(
            ...
            headers=self._headers(file_name, headers),
        )
    ...
    def _check_memory_limit(self, file_data: bytes | io.BytesIO) -> None:
